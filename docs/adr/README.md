...
| ADR                                       | Title                         | Summary                                                                                                                                                                                                               |
| ----------------------------------------- | ----------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [0001](0001-zero-runtime-dependencies.md) | Zero runtime dependencies     | The package declares no `dependencies`; React, React DOM, and `classnames` are peer dependencies kept external at build time. **Superseded for icons (v1.12.0): `naive-icons` is now the single runtime dependency.** |
